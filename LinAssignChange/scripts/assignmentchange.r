...
########
render("scripts/COVID19_assignmentThroughTime_report.Rmd",output_file=paste0("COVID19_assignmentThroughTime_report",linFocusName,".html"), output_dir = outputDir, params = list(output_dir = outputDir))
